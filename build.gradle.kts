...
buildscript {
	...
	dependencies { classpath(buildLibs.jackson.core) }
}
...
group = "com.amuzil.forgekonfig"

version = "1.0.0"

description = "Automatically load configuration values from a Forge's mods.toml"
...
dependencies {
	...
	implementation(buildLibs.fourkoma)
...
sonarqube {
	properties {
		property("sonar.projectKey", "amuzil_forgekonfig")
...
gradlePlugin {
	website.set("https://docs.amuzil.com/forgekonfig/")
	vcsUrl.set("https://github.com/amuzil/forgekonfig/")
	plugins {
		create("forgekonfig") {
			id = "com.amuzil.forgekonfig"
			implementationClass = "com.amuzil.forgekonfig.ForgeKonfig"
			displayName = "ForgeKonfig"
